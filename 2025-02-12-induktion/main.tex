...
Vores matematiske induktion kommer til at gøre brug af to grundlæggende fakta om de positive heltal tal, som vi her vil tage for givet. Det første princip er at hvis vi har et  tal \(n\in\N_0\), så er der et entydigt ``næste tal,'' netop \(n+1\). På samme måde har \(n\) også et entydigt ``forrige tal,'' altså hvis \(n\neq 0\).
...
\[
  ...
  \[
    ...
    \[
      ...
      Her kommer den generelle procedure for et induktionsbevis.
\end{document}
